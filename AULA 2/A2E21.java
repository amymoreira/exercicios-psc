...
/*Ler três números e escrever o maior número (suponha números diferentes).*/
{
   public static void main(String[] args)
   {
      ...
      if (numero1 > numero2 && numero1 > numero3)
         {
         JOptionPane.showMessageDialog(null, "O maior número informado é: " + numero1);
         }
         
      else if (numero2 > numero1 && numero2 > numero3)
         {
         JOptionPane.showMessageDialog(null, "O maior número informado é: " + numero2);
         }
         
      else
         {
         JOptionPane.showMessageDialog(null, "O maior número informado é: " + numero3);
         }
   }
}